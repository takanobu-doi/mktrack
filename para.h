...
const char detection_gas[128] = "iso-C4H10-10"; // CH4 iso-C4H10 CH4-* iso-C4H10-*
const int press = 100;   // hPa
...
std::map<const std::string,const double> density = {
  ...
  {"CH4-80",(0.00065819*.90+0.00008271*(1.-.80))*press/1000.},
  ...
  {"CH4-10",(0.00065819*.90+0.00008271*(1.-.10))*press/1000.}
};
...
std::map<const std::string,const double> W_Val = {
  ...
  {"iso-C4H10-80",10.68*.90+13.598*(1.-.80)},
  {"CH4-80",12.61*.90+13.598*(1.-.80)},
  {"iso-C4H10-70",10.68*.90+13.598*(1.-.70)},
  {"CH4-70",12.61*.90+13.598*(1.-.70)},
  {"iso-C4H10-60",10.68*.90+13.598*(1.-.60)},
  {"CH4-60",12.61*.90+13.598*(1.-.60)},
  {"iso-C4H10-50",10.68*.90+13.598*(1.-.50)},
  {"CH4-50",12.61*.90+13.598*(1.-.50)},
  {"iso-C4H10-40",10.68*.90+13.598*(1.-.40)},
  {"CH4-40",12.61*.90+13.598*(1.-.40)},
  {"iso-C4H10-30",10.68*.90+13.598*(1.-.30)},
  {"CH4-30",12.61*.90+13.598*(1.-.30)},
  {"iso-C4H10-20",10.68*.90+13.598*(1.-.20)},
  {"CH4-20",12.61*.90+13.598*(1.-.20)},
//****  {"iso-C4H10-10",10.68*.90+13.598*(1.-.10)},
  {"iso-C4H10-10",10.},
  {"CH4-10",12.61*.90+13.598*(1.-.10)}
};
#endif
